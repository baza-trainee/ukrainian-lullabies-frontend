    ...
    resources: {
      en: {
        translations: {
          ...
          supportDescription3: "Sincerely, the team of the “Ukrainian Lullabies” project.",
          ourPartners: "Our partners",
          feedbackForm: "Feedback form",
          contactUs: "If you have any questions/suggestions/wishes - we are waiting for your messages.",
          name: "Name",
          taras: "Taras",
          ...
          shareText: "The text has been copied",
          recipientName: "Recipient's name",
          ngoLullabyMuseum: "NGO LULLABY MUSEUM",
          recipientCode: "Recipient's code",
          recipientAccount: "Recipient’s account number (IBAN)",
          bankName: "Bank name",
          jscCbPrivatbank: 'JSC CB "PrivatBank"',
          paymentPurpose: "Payment purpose",
          paymentPurposePlaceholder1: "Non-refundable financial aid from",
          paymentPurposePlaceholder2: "Last name, first name",
          ...
          schema: {
            ...
            themeNotAllowedMessage: "Field contains illegal characters or a space at the beginning",
            ...
            messageNotAllowedMessage: "Field contains illegal characters or a space at the beginning",
      ...
      ua: {
        translations: {
          ...
          shareText: "Текст скопійовано",
          recipientName: "Найменування отримувача",
          ngoLullabyMuseum: "ГО МУЗЕЙ КОЛИСКОВОЇ",
          recipientCode: "Код отримувача",
          recipientAccount: "Рахунок отримувача (IBAN)",
          bankName: "Назва банку",
          jscCbPrivatbank: 'АТ КБ "ПРИВАТБАНК"',
          paymentPurpose: "Призначення платежу",
          paymentPurposePlaceholder1: "Безповоротна фінансова допомога від",
          paymentPurposePlaceholder2: "Прізвище, ім'я, по-батькові.",
          ...
          schema: {
            nameInvalidName: "Поле має містити 1-30 символів із літер, апострофу, тире або пробілу, не на початку",
            nameNotAllowedMessage: "Поле має містити 1-30 символів із літер, апострофу, тире або пробілу, не на початку",
            nameMinLengthMessage: "Поле має містити 1-30 символів із літер, апострофу, тире або пробілу, не на початку",
            nameMaxLengthMessage: "Поле має містити 1-30 символів із літер, апострофу, тире або пробілу, не на початку",
            ...
            themeNotAllowedMessage: "Поле містить заборонені символи або пробіл на початку",
            ...
            messageNotAllowedMessage: "Поле містить заборонені символи або пробіл на початку",
            messageMaxLengthMessage: "Кількість символів має бути не більше 600",
          },
        },
      },
    },
