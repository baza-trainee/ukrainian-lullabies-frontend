  ...
  return <section id="map" className="map-catalogue" >
    ...
    <div className="map">
      <svg className="svg-map" viewBox="0 0 990 655">
        ...
        <NavLink onClick={() => { handleRegionHover(photo1, "hoverPattern1"); setOnButtonClick(true) }} className="nav" to="/player">
        ...
        <NavLink onClick={() => { handleRegionHover(photo2, "hoverPattern2"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region2"
        ...
        <NavLink onClick={() => { handleRegionHover(photo3, "hoverPattern3"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region3"
        ...
        <NavLink onClick={() => { handleRegionHover(photo4, "hoverPattern4"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region4"
        ...
        <NavLink onClick={() => { handleRegionHover(photo5, "hoverPattern5"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region5"
        ...
        <NavLink onClick={() => { handleRegionHover(photo6, "hoverPattern6"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region6"
        ...
        <NavLink onClick={() => { handleRegionHover(photo7, "hoverPattern7"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region7"
        ...
        <NavLink onClick={() => { handleRegionHover(photo8, "hoverPattern8"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region8"
        ...
        <NavLink onClick={() => { handleRegionHover(photo9, "hoverPattern9"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region9"
        ...
        <NavLink onClick={() => { handleRegionHover(photo10, "hoverPattern10"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region10"
        ...
        <NavLink onClick={() => { handleRegionHover(photo11, "hoverPattern11"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region11"
        ...
        <NavLink onClick={() => { handleRegionHover(photo12, "hoverPattern12"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region12"
        ...
        <NavLink onClick={() => { handleRegionHover(photo13, "hoverPattern13"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region13"
        ...
        <NavLink onClick={() => { handleRegionHover(photo14, "hoverPattern14"); setOnButtonClick(true) }} className="nav" to="/player">
          <path className="path-map"
            id="region14"
