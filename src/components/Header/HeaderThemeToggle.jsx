        ...
        {!isLightTheme ? (
          ...
          <svg width="32" height="32" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M17 34C26.3888 34 34 26.3888 34 17C34 7.61116 26.3888 0 17 0C7.61116 0 0 7.61116 0 17C0 26.3888 7.61116 34 17 34ZM6.97594 6.41038C7.47307 5.8978 8.29422 5.95844 8.76274 6.49728C9.23126 7.03612 9.16862 7.84856 8.6805 8.36971C7.73421 9.38003 6.95847 10.5413 6.38682 11.8085C5.63754 13.4694 5.25666 15.2728 5.27036 17.0949C5.28405 18.917 5.692 20.7145 6.46617 22.3639C7.0568 23.6224 7.84992 24.7719 8.81129 25.7678C9.30719 26.2816 9.38204 27.093 8.92167 27.6388C8.46131 28.1847 7.64115 28.2576 7.13638 27.7526C5.89435 26.5099 4.87464 25.059 4.12538 23.4626C3.19264 21.4753 2.70114 19.3096 2.68464 17.1143C2.66814 14.9191 3.12702 12.7463 4.02978 10.7452C4.75495 9.13769 5.75274 7.67161 6.97594 6.41038Z"
              fill="black"
            />
          </svg>
        )}
